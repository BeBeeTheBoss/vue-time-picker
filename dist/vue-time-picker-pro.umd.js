(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-time-picker-pro"] = factory(require("vue"));
	else
		root["vue-time-picker-pro"] = factory(root["Vue"]);
...
const angle = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('');
props.hourOrMinute == "hour" ? angle.value = (props.number * 30) : angle.value = (props.number/5 * 30);
const selectedNumber = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('');
...
const multiplyNumber = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('');
...
return (_ctx, _cache) => {
  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
    class: "clock",
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)('outline: 10px solid ' + props.bg)
  }, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", {
      class: "numerals",
      style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)('color:' + props.bg)
    }, [
      ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)(12, (n) => {
        return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", {
          class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)([n == selectedNumber.value ? 'clicked' : '', "numeral"]),
          key: n,
          style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)([[getNumberLocation(n), n == selectedNumber.value ? { 'background-color': props.bg } : {}], {"cursor":"pointer"}]),
          onClick: $event => (setHandAngle(n),_ctx.$emit('clicked',n))
        }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(n == 12 && __props.hourOrMinute == "minute" ? "00" : n * multiplyNumber.value), 15, _hoisted_1)
      }), 64))
    ], 4),
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", {
      class: "hand",
      style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)({ transform: `translateX(-50%) rotate(${angle.value}deg)` })
    }, null, 4),
    _cache[0] || (_cache[0] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", { class: "center" }, null, -1))
  ], 4))
}
}
...
const emit = __emit;
const hourOrMinute = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('hour');
const amOrPm = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('AM');
const hourData = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('12');
const minuteData = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)('00');
...
return (_ctx, _cache) => {
  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", TimePickervue_type_script_setup_true_lang_js_hoisted_1, [
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
        type: "text",
        id: "hourAndMinuteBox",
        style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)('background-color:' + props.bg),
        onClick: _cache[0] || (_cache[0] = $event => (switchClock('hour')))
      }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(hourData.value), 5),
      _cache[4] || (_cache[4] = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", { style: {"font-size":"30px","font-weight":"bold"} }, ":", -1)),
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
        type: "text",
        id: "hourAndMinuteBox",
        style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)('background-color:' + props.bg),
        onClick: _cache[1] || (_cache[1] = $event => (switchClock('minute')))
      }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(minuteData.value), 5),
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_2, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", null, [
          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
            type: "text",
            class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)(amOrPm.value == 'AM' ? 'clicked' : ''),
            id: "amAndPmBox",
            style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)(amOrPm.value == 'AM' ? 'background-color:' + props.bg : ''),
        ...
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", null, [
          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
            type: "text",
            class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)(amOrPm.value == 'PM' ? 'clicked' : ''),
            id: "amAndPmBox",
            style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)(amOrPm.value == 'PM' ? 'background-color:' + props.bg : ''),
    ...
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_3, [
      (hourOrMinute.value == 'hour')
        ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(Clock, {
            key: 0,
...
//# sourceMappingURL=vue-time-picker-pro.umd.js.map